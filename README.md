...
> **Note**
> Everywhere in this repository, make sure to replace `rilicthefox/ublue-phoenix` with the details of your own repository. Unless you used one of the automatic repository setup tools in which case the previous repo identifier should already be your repo's details.
...
- Then rebase to the signed image, like so:
  ```
  sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/rilicthefox/ublue-phoenix:latest
  ```
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/rilicthefox/ublue-phoenix:20230403
```
